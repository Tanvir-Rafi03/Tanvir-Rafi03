...
<img src="assets/hero.svg" alt="TANVIR RAFI — Full-Stack Developer" width="100%">
...
> A data-worm defragmenting a year of commits. Every cell is a real day —
> it lights up, gets consumed, and regenerates as the score climbs.

<div align="center">

<img src="assets/contribution-arcade.svg" alt="Contribution arcade — 354 contributions defragmented" width="100%">

<sub>`AUTO-REGENERATED DAILY` · built by [`scripts/gen_arcade.py`](scripts/gen_arcade.py) from the live GitHub contributions API</sub>
...
<img src="assets/arsenal.svg" alt="Tech stack loadout" width="100%">
...
<sub>`< tanvir />` — Building cool things with code.</sub>
